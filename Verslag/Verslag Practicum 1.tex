...
De implementatie van de berekening van de coëfficiënten kan gevonden worden in deBoor.m, welke op pagina \pageref{sec:codedb} uitgeschreven staat.
...
De ruis wordt gemodelleerd aan de hand van (\ref{eq:noise}).
